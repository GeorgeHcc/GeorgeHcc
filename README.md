...
<img src="https://skillicons.dev/icons?i=js,ts,nodejs,wasm,go,rust,cpp,react,vue,angular,nuxt,next,nest,webpack,vite,rollup,gulp,babel,tensorflow,docker,k8s,linux,python,java,github,nginx,mongodb,graphql&perline=18"/>
