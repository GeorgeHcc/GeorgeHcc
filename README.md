...
<img src="https://skillicons.dev/icons?i=js,ts,nodejs,wasm,go,rust,cpp,react,vue,angular,swift,nuxt,next,nest,webpack,vite,rollup,gulp,redux,babel,tensorflow,docker,k8s,linux,python,java,github,nginx,mongodb,graphql,tailwind&perline=18"/>
